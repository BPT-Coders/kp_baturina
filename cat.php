...
<body onLoad="onLoad(); showTovarsOnCat(<?php echo $idCat; ?>)">
				...
				<div id="content">
					<section class="products" id="products">
						<article>
							...
							<h3><a href="product.php">Золотые серьги "Алиния"</a></h3>
							<h4><a href="product.php">19 990 руб.</a></h4>
		...
		<div class="container">
			<div class="cols">
				...
				<div class="col newsletter">
					...
					<form action="#">
						<input type="text" placeholder="Ваш адрес электрнной почты...">
